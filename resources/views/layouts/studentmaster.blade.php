...
<head>
   ...
   <meta charset="utf-8">
	...
	<!-- Page Title Here -->
	<title>@yield('title','Learner Dashboard')</title>
								...
								<div class="dropdown header-profile2">
									<a class="nav-link ms-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
										<div class="header-info2 d-flex align-items-center">
											...
											<img src="/upload/student/{{ Auth('student')->user()->image}}" alt="student-img">
										</div>
									</a>
										...
										<div class="card mb-0">
											<div class="card-header p-3">
												<ul class="d-flex align-items-center">
													<li>
														<img src="/upload/student/{{ Auth('student')->user()->image}}" class="ms-0" alt="student-img">
													</li>
													<li class="ms-2">
														<h4 class="mb-0">{{ Auth('student')->user()->fname}}</h4>
														<span>Learner</span>
													</li>
												</ul>
											...
											<div class="card-body p-3">
												<a href="/student-profile" class="dropdown-item ai-icon ">
												...
												<a href="javascript:void(0);" class="dropdown-item ai-icon" data-id="{{Auth('student')->user()->id}}" data-bs-toggle="modal" id="passchange" data-bs-target="#accountsetting">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="dlabnav">
			<div class="dlabnav-scroll">	
				<ul class="metismenu" id="menu">
					...
					<li>
						<a class="" href="/student-subjects" aria-expanded="false">
					...
					@if (auth('student')->user()->status == 1)
					<li>
						<a class="" href="{{url('student-online-classes')}}" aria-expanded="false">
							<i class="material-icons">folder</i>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="/updateStudentPass" method="POST">
							@csrf
							<div class="mb-3 col-md-12">
								...
								<input type="hidden" id="userID" value="" name="sid">
